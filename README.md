...
<body>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    ...
    <p>DEVELOPED BY Gokul S(212221220013)</p>
  </footer>
...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          abcsaveetha@pharmacompany.com<br><br>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-2">
    <p>&copy; 2024 PharmaCompany. All rights reserved by Gokul S</p>
  </footer>
